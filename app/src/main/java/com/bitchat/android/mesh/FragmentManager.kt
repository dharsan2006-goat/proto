...
class FragmentManager {
    ...
    private val incomingFragments = ConcurrentHashMap<String, ConcurrentHashMap<Int, ByteArray>>()
    ...
    fun handleFragment(packet: BitchatPacket): BitchatPacket? {
        ...
        try {
            ...
            // Use computeIfAbsent for atomic check-then-create with thread-safe inner map
            val fragmentMap = incomingFragments.computeIfAbsent(fragmentIDString) {
                ConcurrentHashMap()
            }
            fragmentMetadata.putIfAbsent(fragmentIDString, Triple(
