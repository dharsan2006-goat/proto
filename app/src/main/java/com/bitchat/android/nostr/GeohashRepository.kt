...
class GeohashRepository(
    ...
    private val geohashParticipants: MutableMap<String, MutableMap<String, Date>> = java.util.concurrent.ConcurrentHashMap()


    // pubkeyHex(lowercase) -> nickname (without #hash)
    private val geoNicknames: MutableMap<String, String> = java.util.concurrent.ConcurrentHashMap()

    // conversation key (e.g., "nostr_<pub16>") -> source geohash it belongs to
    private val conversationGeohash: MutableMap<String, String> = java.util.concurrent.ConcurrentHashMap()
    ...
    private val nostrKeyMapping: MutableMap<String, String> = java.util.concurrent.ConcurrentHashMap()
