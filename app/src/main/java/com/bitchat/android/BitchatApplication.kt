...
/**
 * Main application class for MeshWave Android
 */
class MeshWaveApplication : Application() {
    ...
    override fun onCreate() {
        ...
        // Initialize LoRa bridge config preferences
        try { com.bitchat.android.mesh.LoRaConfigPreferences.init(this) } catch (_: Exception) { }
